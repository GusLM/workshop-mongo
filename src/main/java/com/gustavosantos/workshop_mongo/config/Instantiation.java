...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null, sdf.parse("2026-01-12"), "Post 1", "This is the first post", maria);
        Post post2 = new Post(null, sdf.parse("2026-01-13"), "Post 2", "This is the second post", alex);
        Post post3 = new Post(null, sdf.parse("2026-01-14"), "Post 3", "This is the third post", bob);
